...
async def count(
    ...
    по работодателю, по виду занятости или по необходимому для работы опыту и возвращает топ 5 групп с указанием
    для каждой работодателя, вида занятости или опыта работы и количества вакансий в ней
    """
